    ...
    <section id="team" className="py-16 px-6 md:px-20 bg-white text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 justify-items-center">
        ...
        <div className="p-6 shadow-md rounded-lg bg-white w-56">
          ...
          />
          <h3 className="mt-4 font-bold">Kadek Diana Angelika Prasanti.</h3>
          <p className="text-sm text-gray-600">Founder & Team Leader</p>
        </div>
        ...
        <div className="p-6 shadow-md rounded-lg bg-white w-56">
          <img
            ...
            className="w-32 h-32 mx-auto rounded-full object-cover"
          />
          <h3 className="mt-4 font-bold"> Ni Komang Dela Damayanti.</h3>
        ...
        <div className="p-6 shadow-md rounded-lg bg-white w-56">
          <img
            ...
            className="w-32 h-32 mx-auto rounded-full object-cover"
          />
          <h3 className="mt-4 font-bold">I Dewa Gede Mas Bagus Krisnanda.</h3>
        ...
        <div className="p-6 shadow-md rounded-lg bg-white w-56">
          <img
            ...
            className="w-32 h-32 mx-auto rounded-full object-cover"
          />
          <h3 className="mt-4 font-bold">I Kadek Indra Satya Ananda.</h3>
        ...
        <div className="p-6 shadow-md rounded-lg bg-white w-56">
          <img
            ...
            className="w-32 h-32 mx-auto rounded-full object-cover"
          />
          <h3 className="mt-4 font-bold"> I Made Dwitya Rastiawan.</h3>
          <p className="text-sm text-gray-600">Hustler</p>
        </div>
      </div>
    </section>
  );
