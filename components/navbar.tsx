...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-20 py-4 bg-[#FFFFFF] shadow-md fixed w-full z-50">
      <a href="#team">
      ...
      <ul
        className={`md:flex gap-6 absolute md:static bg-[#FFFFFF] left-0 w-full md:w-auto p-4 md:p-0 transition-all ${
