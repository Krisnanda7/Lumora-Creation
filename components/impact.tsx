...
export default function Impact() {
  return (
    <section
      id="impact"
      className="py-20 px-6 md:px-20 bg-white text-center font-sans-serif"
    >
      <div data-aos="fade-left" data-aos-duration="2000">
        <h2 className="text-4xl md:text-5xl font-bold  text-gray-800 mb-10 font-sans-serif italic">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 ">
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border  border-gray-100 hover:border-amber-500 ">
            ...
            <p className="text-gray-600 text-lg">
              Terbuat dari minyak jelantah daur ulang, membantu mengurangi
